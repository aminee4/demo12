...
} from "../../Resources/image/arrowRight.svg";
import {
    ReactComponent as Cross
} from "../../Resources/image/cross.svg";
import {
    motion,
    AnimatePresence
} from "framer-motion";
...
const Cart = props => {
    ...
    return ( <
        ...
        <
        h2 > {
            cartAmount >= 1 ? cartAmount > 1 ? `${cartAmount} games` : "1 game" : "No games added"
        } < /h2> <
        h3 onClick = {
            clearCart
        } > {
        ...
        style = {
            {
                fill: hoverState[24].hovered ? "#92f" : "#fff"
            }
        }
        /> <
        /button> <
