...
} from "../../Resources/image/logo.svg";
import {
    ReactComponent as AppStore
} from "../../Resources/image/appstorebadge.svg";
...
const Footer = props => {
    ...
    return ( <
        ...
        /div> <
        div className = {
            `${styles.section} ${styles.section3}`
        } >
        <
        h3 className = {
            styles.first
        ...
        /div> <
        div className = {
            `${styles.section} ${styles.section4}`
        } >
        <
        h3 className = {
            styles.first
        ...
        src = {
            require("../../Resources/image/googleplaybadge.png")
        }
        ...
        src = {
            require("../../Resources/image/twitter.png")
        }
        alt = "Twitter Logo" / >
        <
        img className = {
        ...
        src = {
            require("../../Resources/image/instagram.png")
        }
        alt = "Instagram Logo" / >
        <
        /div> <
