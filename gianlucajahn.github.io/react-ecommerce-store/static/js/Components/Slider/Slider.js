...
import {
    ReactComponent as Left
} from "../../Resources/image/left.svg";
import {
    ReactComponent as Right
} from "../../Resources/image/right.svg";
import {
    ReactComponent as Dot
} from "../../Resources/image/dot.svg";
import {
    useLocation
...
const Slider = props => {
    ...
    return ( <
        ...
        style = {
            {
                fill: hoverState[22].hovered ? "#fff" : "#ccc"
            }
        }
        /> <
        /button>
        ...
        style = {
            {
                fill: hoverState[23].hovered ? "#fff" : "#ccc"
            }
        }
        /> <
        /button> <
